GET : https://thaylong-admin-dashboard.github.io/assets/css/dashboard.css
RESPONSE: .dashboard-body {
...
.sidebar__nav-link.is-active {
  background: linear-gradient(90deg, rgba(37, 99, 235, 0.26), rgba(6, 182, 212, 0.08));
  color: #fff;
...
GET : https://thaylong-admin-dashboard.github.io/assets/js/pages/dashboard-home.js
RESPONSE: 
...
RESULT: blank https://thaylong-admin-dashboard.github.io/dashboard/